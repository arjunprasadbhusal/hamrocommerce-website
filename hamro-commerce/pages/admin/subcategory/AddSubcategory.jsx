...
import { FolderTree, Folder, Save, X, AlertCircle, CheckCircle } from 'lucide-react'
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <h1 className="text-3xl font-bold text-gray-800">
                  {selectedCategoryName ? `Add Subcategory to ${selectedCategoryName}` : 'Add New Subcategory'}
                </h1>
                <p className="text-gray-500 text-sm">Create a new product subcategory</p>
              </div>
            </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-blue-800">
                      ...
                      <p className="text-blue-700">Subcategories help organize products within their parent categories for better navigation.</p>
                    </div>
                  </div>
                </div>
